        ...
        public Account EditPatientAccount(Patient patient, string patientID)
        {
            foreach (Patient oldPatient in Patients)
            {
                if (oldPatient.ID.Equals(patientID))
                {
                    ...
                    oldPatient.currentMonthUsableForCancellingAppointmentsByPatient = patient.currentMonthUsableForCancellingAppointmentsByPatient;
                    oldPatient.currentYearUsableForCancellingAppointmentsByPatient = patient.currentYearUsableForCancellingAppointmentsByPatient;
                    oldPatient.numberOfCancelledAppointmentsByPatientMonthly = patient.numberOfCancelledAppointmentsByPatientMonthly;
                }
            }
            return null;
        }
